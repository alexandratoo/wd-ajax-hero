(function() {
    ...
    $("button").click(function(event) {
        /////prevent stupid click button from not console logging ;)
        if ($("#search").val() !== "") {
            event.preventDefault();
            ///get the info from the ajax site, use s as a way to get all generl information
            $.ajax({
                ...
                success: function(data) {
                    for (var i = 0; i < data.Search.length; i++) {
                        ...
                        $.ajax({
                            ...
                            method: "GET",
                            success: function(data) {
                                //stringify data to get into a usable form.
                                var thisMovie = {
